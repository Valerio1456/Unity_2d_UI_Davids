...
public class DragAndDropS : MonoBehaviour, IPointerDownHandler, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    {
        Debug.Log("Objekts atlaists, vilksana partraukta!");
    }
